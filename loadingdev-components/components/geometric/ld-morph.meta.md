...
**Tags**: morph, shape-shift, convert, topology, vector

---

## 1. Physical Metaphor & Visual Signature
Topological 2D shape interpolation.
...
| Dimension | Guidance |
| :--- | :--- |
| **When to Use** | File format conversion, view mode toggle (grid to list), vectorization rendering |
| **When NOT to Use** | Strict non-polymorphic basic waiting states |
...
<button style="display: inline-flex; align-items: center; gap: 8px;">
  ...
  <span style="display: inline-flex; align-items: center;">
    <div class="ld-morph" aria-hidden="true" style="--ld-size: 16px;">
  <div class="ld-morph-shape"></div>
</div>
  </span>
</button>
```
